...
So, after cloning the forked repository to your system, use the command `git remote add upstream https://github.com/TasnimAnas/Searching-Algorithms` to point to the main repository. You only need to do this once.
